...
#    lines(t_fwd_plt,totF_Millennial2_C_fwd_plt,type="l", lty=1, col="blue")
  ...
  return(list(Roth_C_fwd,ICBM_C_fwd,Century_C_fwd,Yasso07_C_fwd,Yasso20_C_fwd,SG_C_fwd,mmmean_totC))
