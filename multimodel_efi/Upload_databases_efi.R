...
print(".......Temperature open rcp26 done ......")
#----------------------------------------------------
#Read lon-lat-time variables
lon_temp_rcp26 <- ncvar_get(temp_file_rcp26, varid = "lon")
lat_temp_rcp26 <- ncvar_get(temp_file_rcp26, varid = "lat")
print(".......Temperature done lon-lat......")
#temp_time_rcp26 <- as.Date("2006-1-1") %d+% days(temp_file_rcp26$dim$time$vals)
#temp_time_rcp26 <- nc.get.time.series(temp_file_rcp26, v = "tas",ddd
#time.dim.name = "time")
temp_time_rcp26 <- ncvar_get(temp_file_rcp26, varid = "time")
print(".......Temperature done time......")
#Convert time to dates
temp_time_plot_rcp26 <- as.Date(temp_time_rcp26, origin="2006-1-1")
print(".......Temperature done time to dates......")
#Retrieve variable for whole time length
temp_rcp26 <- ncvar_get(temp_file_rcp26, "tas")
#<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
print(".......Temperature rcp26 done ......")
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#----------------------------------------------------
...
prec_time_rcp26 <- ncvar_get(prec_file_rcp26, varid = "time")
#Convert time to dates
prec_time_plot_rcp26 <- as.Date(prec_time_rcp26, origin="2006-1-1")
#Retrieve variable for whole time length
...
if(rcp==60) {
  ...
  temp_time_rcp60 <- ncvar_get(temp_file_rcp60, varid = "time")
  #Convert time to dates
  temp_time_plot_rcp60 <- as.Date(temp_time_rcp60, origin="2006-1-1")
  #Retrieve variable for whole time length
  ...
  prec_time_rcp60 <- ncvar_get(prec_file_rcp60, varid = "time")
  #Convert time to dates
  prec_time_plot_rcp60 <- as.Date(prec_time_rcp60,origin="2006-1-1")
  #Retrieve variable for whole time length
